...
public class FabricanteDAO {
	public void salvar(Fabricante f) throws SQLException {
		...
		sql.append("INSERT INTO fabricantes ");
	...
	/*
	 * public static void main(String[] args) { Fabricante f1 = new
	 * Fabricante(); f1.setDescricao("4");
	 * 
	 * FabricanteDAO fdao = new FabricanteDAO();
	 * 
	 * try { ArrayList<Fabricante> lista = fdao.buscaPorDescricao(f1);
	 * 
	 * for (Fabricante f : lista) { System.out.println("Resultado " + f); } }
	 * catch (Exception e) { System.out.println("Erro ao buscar Fabricante");
	 * e.printStackTrace(); }
	 * 
	 * }
	 * 
	 * FabricanteDAO fdao = new FabricanteDAO(); try { ArrayList<Fabricante>
	 * lista = fdao.listar(); for (Fabricante f : lista) {
	 * System.out.println("Resultado: " + f); } } catch (SQLException e) {
	 * System.out.println("Erro ao listar os fabricantes"); e.printStackTrace();
	 * }
	 * 
	 * 
	 * 
	 ...
	 * System.out.println("Erro ao pesquisar um fabricante");
	 * e.printStackTrace(); }
	 * 
	 * 
	 * Fabricante f1 = new Fabricante(); f1.setCodigo(3L);
	 ...
	 * 
	 * try { fdao.editar(f1);
	 * System.out.println("Fabricante editado com sucesso"); } catch
	 * (SQLException e) { System.out.println("Erro ao editar um fabricante");
	 * e.printStackTrace(); }
	 * 
	 ...
	 * (SQLException e) { System.out.println("Erro ao excluir o fabricante!");
	 * e.printStackTrace(); }
	 * 
	 * 
	 ...
	 * (SQLException e) { System.out.println("Erro ao salvar fabricante");
	 * e.printStackTrace(); }
	 */
