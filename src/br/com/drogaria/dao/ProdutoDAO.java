...
public class ProdutoDAO {
	public void salvar(Produto p) throws SQLException {
		...
		sql.append("(descricao, preco, quantidade, fabricantes_codigo) ");
		sql.append("VALUES(?, ?, ?, ?) ");
	...
	public ArrayList<Produto> listar() throws SQLException {
		...
		sql.append("FROM db_drogaria_1.produtos p ");
		sql.append("JOIN db_drogaria_1.fabricantes f ");
		sql.append("WHERE p.fabricantes_codigo = f.codigo;");
	...
	public void editar(Produto p)throws SQLException{
		...
		sql.append("SET descricao = ?, preco = ?, quantidade = ?, fabricantes_codigo = ? ");
		sql.append("WHERE codigo = ? ");
