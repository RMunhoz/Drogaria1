...
public class FabricanteBean {
	...
	public void novo() {
		try {
			...
			itens = dao.listar();
			JSFUtil.adicionarMsgSucesso("Fabricante salvo com sucesso!");
		} catch (SQLException ex) {
			ex.printStackTrace();
			JSFUtil.adicionarMsgErro(ex.getMessage());
		}
	...
	public void excluir() {
		try {
			...
			itens = dao.listar();
			JSFUtil.adicionarMsgSucesso("Fabricante removido com sucesso!");
		} catch (SQLException ex) {
			ex.printStackTrace();
			JSFUtil.adicionarMsgErro(ex.getMessage());
		}
	...
	public void editar() {
		try {
			...
			itens = dao.listar();
			JSFUtil.adicionarMsgSucesso("Fabricante editado com sucesso!");
		} catch (SQLException ex) {
			ex.printStackTrace();
			JSFUtil.adicionarMsgErro(ex.getMessage());
		}
